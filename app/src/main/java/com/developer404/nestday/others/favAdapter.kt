...
class favAdapter : RecyclerView.Adapter<adapter.holder>{

    lateinit var mutableLiveData: MutableLiveData<dataClass>
    lateinit var context : Context
    var fav_data : ArrayList<Data> = ArrayList()

    constructor(mutableLiveData: MutableLiveData<dataClass>, context: Context) : super() {
        this.mutableLiveData = mutableLiveData
        this.context = context

//        val sp = context.getSharedPreferences("fav", AppCompatActivity.MODE_PRIVATE)
//        Log.e("checking", sp.getString(Integer.toString(7),"default").toString() )
//        for (x in 0..5){
//            if (x== sp.getString(x.toString(), "100")?.toInt() ?: 100){
//                fav_data.add(mutableLiveData.value!!.data[x])
////                Log.e("debugging", data.id.toString() )
//            }
//        }
    }
    ...
    override fun onBindViewHolder(holder: adapter.holder, position: Int) {
        ...
        holder.fav.setImageResource(R.drawable.ic_red_fav)
